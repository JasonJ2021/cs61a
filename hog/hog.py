...
def roll_dice(num_rolls, dice=six_sided):
    ...
    "*** YOUR CODE HERE ***"
    i = 0
    flag = False # flag = false represents no 1 occurs
    sum = 0
    while(i < num_rolls) : 
        temp = dice()
        if(temp == 1):
    ...
    def say(score0 , score1):
        if(who == 0):
            if(score0 - last_score > running_high) :
                print(str(score0 - last_score) + " point(s)! That's a record gain for Player " + str(who) + '!')
            ...
            if(score1 - last_score > running_high) :
                print(str(score1 - last_score) + " point(s)! That's a record gain for Player " + str(who) + '!')
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    max_num_rolls = averaged_dice(1,dice)
    max_num = 1
    while(i <= 10):
        averaged_dice = make_averaged(roll_dice , trials_count)
